...
import h5py
filename = 'Holash_Pasquale_Fig7_EphB2_and_EphA4_DV_e8.h5'
...
with h5py.File (filename, 'r') as f:
    ...
    ax1.plot (EphB2_means, color=C.EphB2, label='EphB2 (e8)', linewidth=3)
...
pl.savefig('Holash_Pasquale_Fig7_EphB2_and_EphA4_DV_e8.svg', transparent=True)
pl.show()
