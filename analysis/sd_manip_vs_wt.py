...
for fb in filebases:
    ...
    # SD plots
    ax.errorbar (nt_vals, nt_means_wt_mean, nt_means_wt_sd, color=clr1)
    ax.errorbar (nt_vals, nt_means_manip_mean, nt_means_manip_sd, color=clr2)
    ...
    plt.savefig('{0}_sds.svg'.format(fb))
    plt.show()
