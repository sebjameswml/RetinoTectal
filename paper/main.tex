...
%%%%% Describing the simulation TAKE THIS TO METHOD DETAILS
...
% Keep, but say M grown cones. (M=4 specified in method details)
% ALSO: Put M near competition equation where it's used!
...
% Thi sis in the righ tplace here
...
\subsection*{Simulation} % MOST OF THIS GOES TO METHOD DETAILS, just keep
                         % first sentence, have list of values used in sims, then 'see method details',
