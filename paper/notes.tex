...
g(\rho(\mb{x})) = \mathrm{e}^{-\big(\frac{\rho(\mb{x})-\mb{\gamma}}{2\sigma}\big)^2 }
\end{equation}
...
f(\rho(\mb{x})) = \frac{2}{1 + \mathrm{e}^{-s g(\mb{x})}} - 1
\end{equation}

In one equation:

\begin{equation}\label{eq:gf}
f(\rho(\mb{x})) = \frac{2}{1 + \mathrm{e}^{-s \mathrm{e}^{-\big(\frac{\rho(\mb{x})-\mb{\gamma}}{2\sigma}\big)^2 } }} - 1
\end{equation}
