...
the width of the peak. This is squashed through an inverting sigmoid, with
sharpness parameter $s$:

\begin{equation}\label{eq:f}
f_i\big(\vec{\rho}(\mb{x})\big) = \frac{2}{1 + \mathrm{e}^{-s g_i(\vec{\rho}\,)}} - 1
\end{equation}

In one equation:

\begin{equation}\label{eq:gf}
f_i\big(\vec{\rho}(\mb{x})\big) = \frac{2}{1
