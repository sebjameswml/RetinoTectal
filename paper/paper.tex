...
\end{equation}
%
evaluated at time $t$. $m_1$--$m_5$ are scalar parameters.
...
\begin{equation}
W(d_{kb}) = \begin{cases}
      1 - \frac{d_{kb}}{2r}   & d_{kb} \leq 2r_c \\
     0 & d_{kb} > 2r_c
     \end{cases}
\end{equation}
...
whether the receptor-recetpro interaction, $\mathbf{I}_b$, is repulsive or
...
\begin{figure}
\includegraphics[width=\linewidth]{./images/j4_eE_GJ_wt.png}
...
\includegraphics[width=\linewidth]{./images/j4_eE_GC_wt_rotcmp.png}
\end{subfigure}
\begin{subfigure}{\linewidth}
\includegraphics[width=\linewidth]{./images/j4_eE_GC_tecrot90.png}
\end{subfigure}
\begin{subfigure}{\linewidth}
\includegraphics[width=\linewidth]{./images/j4_eE_GC_tecrot180.png}
\end{subfigure}
\begin{subfigure}{\linewidth}
\includegraphics[width=\linewidth]{./images/j4_eE_GC_tecswap.png}
\end{subfigure}
