...
%
For axon-tectum interactions, we implement attraction as a climbing of the
tectal ligand expression gradient and repulsion as gradient descent.
%
To determine the strength of the effect we assume a purely linear receptor
binding model, and set the movement of the growth cone to be $\sum_i \pm
r_i \times \grad l_i$.

For axon-axon interactions, attraction causes a movement along a vector
between two axons causing them to move closer together; repulsion cause the
opposite effect.
