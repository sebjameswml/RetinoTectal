...
%
%With a suitable choice of threshold, $s$, branches originating from the same
%location on the temporal-nasal axis will not experience competitive
%interactions.
...
%
%Interestingly, the feature of a slight 'elbow' in the double knockin
%graph (F) at about 0.7 on the nasal-temporal axis matches that seen in the
%experimental result. Well, kinda.
...
% What about the EphA manipulations with noise? Ans: No strong effect (just
% add "noise_gain" : 0.5, to one of the expt jsons.
...
% ./scripts/fig_GClikeGJ_surgical.sh
\begin{figure}
\includegraphics[width=\linewidth]{./images/fig_GClikeGJ_surgical.png}
...
\begin{figure}
\includegraphics[width=\linewidth]{./images/EphA_manipulations_GClikeGJ.png}
\caption{$\mathbf{GC}$ model with parameters found from \emph{GJ}
