...
of 4 receptors and 4 ligands which it expresses at differing levels depending
upon the soma's origin on the retina. The expression levels of
the receptors and ligands form gradients across the retinal surface. Receptors
are arranged in orthogonal pairs with $r_0$ being orthogonal to $r_1$ and
$r_2$, whose gradient is opposite to $r_0$ is orthogonal to $r_3$. Ligands are
also arranged in orthogonal pairs, with...
%
