...
New introduction: Simpson and Goodhill presented a model in which the
...
Another approach: We present a model of gradient-following based on graded
...
of 4 receptors and 4 ligands which are expressed at differing levels depending
upon the soma's location on the retina. The expression levels of the receptors
and ligands form gradients across the retinal surface. Receptors are arranged
in orthogonal pairs with $r_0$ being orthogonal to $r_1$ and $r_2$, whose
gradient is opposite to $r_0$ is orthogonal to $r_3$. Ligands are also
arranged in orthogonal pairs, with...
%
Similarly, the tectum expresses the same sets of
receptors and ligands, also in orthogonal pairs of gadients, though not
necessarily with the same expression function.
