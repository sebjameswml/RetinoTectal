...
given axis, following Eq.\,\ref{e:tecexp}.
...
$m_1=0.002$ and $m_2=m_3=m_4=0$ and ran the model for 300 steps.

% ./build/sim/agent/agent1 configs/a1/m_ee_G.json  configs/a1/e_wt.json 300
\begin{figure}
\includegraphics[width=\linewidth]{./images/j4_ee_G_wt.png}
