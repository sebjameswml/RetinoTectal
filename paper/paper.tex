...
receptor-ligand signalled interactions are repulsive, as for EphA-ephrinA
...
% ./build/sim/agent/agent1 configs/simpler/m_ee_G.json  configs/simpler/e_wt_fig1.json
\begin{figure}
...
steps. Fig.\,\ref{f:chemo}A indicates the colour code used for retinal cell
position; dorsal retinal cells are indicated by green, nasal cells by
...
black. Fig.\,\ref{f:chemo}B shows the expected layout of retinal ganglion cell
axons on the tectum. The axons retain the colour of their originating cell on
the retina, as shown in Fig.\,\ref{f:chemo}A. Nasal cell axons should be
arranged caudally; dorsal axons laterally; axons should be evenly spaced and
the pattern should span the entire tectum. Figs.\,\ref{f:chemo}C
and \ref{f:chemo}D show, respectively, the positions of branches (i.e.~growth
cones) and axon centroids at $t=300$. Topographic ordering is
correct. Opposing gradients have sorted the axons along the two axes to form a
grid of cells. However, the arrangement does not span the full
tectum. Fig.\,\ref{f:chemo}E shows selected axons (one from the centre and one
from each corner of the retina) and their position history.
Fig.\,\ref{f:chemo}F shows two pattern metrics; the sum of squared distance
errors of the axon centroids and the number of crossings in the 'fish net'
plot of Fig.\,\ref{f:chemo}D which gives an indication of the disorder in the
arrangement. The expected number of crossings is 0, as in
Fig.\,\ref{f:chemo}B.
...
\begin{figure}
\includegraphics[width=\linewidth]{./images/j4_eE_GJ_wt_fig.png}
...
(Eq.\,\ref{e:tecligexp}). Fig.\,\ref{f:ch}A gives a colour map of retinal
