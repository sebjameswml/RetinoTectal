...
./build/sim/agent/agent1 configs/simpler/m_ee_GJ_best_1.json configs/simpler/e_wt_figcomp2.json -co:steps=2000 -co:noise_gain=0.19 -co:ret_rcpt_noise_gain=0.0  -co:tec_lgnd_noise_gain=0.0 -co:exit=true
./build/sim/agent/agent1 configs/simpler/m_ee_GJ_best_1.json configs/simpler/e_wt_figcomp2.json -co:steps=2000 -co:noise_gain=0.0  -co:ret_rcpt_noise_gain=0.08 -co:tec_lgnd_noise_gain=0.0 -co:exit=true
./build/sim/agent/agent1 configs/simpler/m_ee_GJ_best_1.json configs/simpler/e_wt_figcomp2.json -co:steps=2000 -co:noise_gain=0.0  -co:ret_rcpt_noise_gain=0.0  -co:tec_lgnd_noise_gain=0.08 -co:exit=true
./build/sim/agent/agent1 configs/simpler/m_ee_GJ_best_1.json configs/simpler/e_wt_figcomp2.json -co:steps=2000 -co:noise_gain=0.19 -co:ret_rcpt_noise_gain=0.08 -co:tec_lgnd_noise_gain=0.08 -co:exit=true

./build/sim/agent/agent1 configs/simpler/m_ee_GJ_best_1.json configs/simpler/e_wt_figcomp2.json -co:steps=2000 -co:noise_gain=1 -co:ret_rcpt_noise_gain=0.0  -co:tec_lgnd_noise_gain=0.0 -co:exit=true
